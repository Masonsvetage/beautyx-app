...
**Regola critica:** la miniguida "10 errori che (quasi) tutte facciamo" è il **benvenuto dell'iscrizione**, non un prodotto separato. La CTA è sempre "iscriviti — la miniguida arriva subito gratis". Mai "scarica la miniguida" come azione principale.

---

## STRUTTURA URL E NAVIGAZIONE

- `beautyx.it` → redirect a `/newsletter` per utenti non autenticati (task Davide pendente al 24/07/2026)
...
- La CTA finale di ogni newsletter punta all'iscrizione o a un'azione concreta e singola
- Bottone iscrizione: "Iscriviti gratis" o "Iscriviti — la miniguida arriva subito"
...
- **Budget indicativo:** €10-15/giorno nella fase di test
- **Obiettivo campagna:** Lead Form Ads → iscrizione newsletter
- **Landing di atterraggio:** `/miniguida` (non `/newsletter` — più diretta per il traffico freddo da ads)
