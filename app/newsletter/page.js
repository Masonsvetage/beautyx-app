        ...
        <section style={{ background: '#fff', padding: '80px 32px' }}>
          <div style={{ maxWidth: '720px', margin: '0 auto' }}>
            ...
            <div style={{ fontSize: 'clamp(15px, 1.8vw, 17px)', color: '#555', lineHeight: 1.85 }}>
              ...
              <p style={{ marginBottom: '18px' }}>
                Prima ancora del metodo, c&apos;è una cosa che vale la pena dirti chiaro: passi le giornate a prenderti cura di clienti, dipendenti, del centro intero — e quasi mai qualcuno pensa a prendersi cura di te. È da lì che nasce quello che noi chiamiamo CURA: il metodo che si prende cura di te, prima ancora che del tuo centro, costruito centro dopo centro, anno dopo anno, capace di trasformare quel materiale in un&apos;indicazione concreta, misurabile, che puoi applicare da subito nella tua realtà — i tuoi numeri, le tue clienti, il tuo team. Con CURA arrivano quattro passaggi, uno via l&apos;altro: Consapevolezza, Unisono degli Elementi, Risveglio del Potenziale, Ascesa Strategica. È qui che entra l&apos;esperienza di chi la gestione l&apos;ha fatta sul campo, ed è qui che nasce il supporto vero: qualcuno che ti accompagna, passo dopo passo, attraverso questi quattro passaggi, a costruire competenze di gestione e autonomia che finora nessuno ti aveva insegnato davvero.
              </p>
              <p>
